...
alh = SwarmPackagePy.z_bfoa_multiniche_sharing_v4_chi(n, f, -r, r, dim, 100, 16, 2, 8, 12, step_size, 0.25, 0.05, 0.2, 0.05, 10, lamda, 0.03, 'none' '''adaptive1 also''', 'swarm2', 'false', sigma_share,d_min, d_max, clust_alpha)
trained_centers = alh._get_cluster_centroids()
trained_centers_fit = alh._get_cluster_centroids_fit()
#Chi Test
alh = SwarmPackagePy.z_bfoa_multiniche_sharing_v4_chi_test(n, f, -r, r, dim, 100, 16, 2, 8, 12, step_size, 0.25, 0.05, 0.2, 0.05, 10, lamda, 0.03, 'none' '''adaptive1 also''', 'swarm2', 'false', sigma_share,d_min, d_max, clust_alpha, 'true', trained_centers, trained_centers_fit)
...
chi = alh._get_chilist()
#print(chi)
plt.plot(chi, 'r', label='CHI Distribution')
plt.show()
