...
class z_bfoa_multiniche(intelligence.sw):
    """
    ...
    def __init__(self, n, function, lb, ub, dimension, iteration, Nre=16, Ned=4, Nc=2, Ns=12, C=0.1, Ped=0.25, Da=0.1, Wa=0.2, Hr=0.1, Wr=10, lamda=400, L=0.03, arga='none', argj='none', arged='false'):
        """
        ...
        super(z_bfoa_multiniche, self).__init__()
