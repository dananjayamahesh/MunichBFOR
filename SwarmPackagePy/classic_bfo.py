...
class classic_bfo(intelligence.sw):
    """
    Bacteria Foraging Optimization
    """

    def __init__(self, n, function, lb, ub, dimension, iteration, Nre=16, Nel=4, Nc=2, Ns=12, C=0.1, Ped=0.25, lamda=1 / 16):
        """
        ...
        super(classic_bfo, self).__init__()
