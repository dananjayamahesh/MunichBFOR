...
class abfo2_with_env_swarm(intelligence.sw):
    """
    ...
    def __init__(self, n, function, lb, ub, dimension, iteration,
                 Nc=2, Ns=12, C=0.2, Ped=1.15, da=0.1, wa=0.2, hr=0.1, wr=10, M=0):
        """
    ...
    :wr: Width/Rate of the repellent (default value is 1.15)
        ...
        super(bfo_with_env_swarm, self).__init__()
