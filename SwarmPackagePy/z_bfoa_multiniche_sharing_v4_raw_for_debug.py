...
class z_bfoa_multiniche_sharing_v4_raw_for_debug(intelligence.sw):
    """

    FInalized Sharing for BFOA - V4
    ...
    def __init__(self, n, function, lb, ub, dimension, iteration, Nre=16, Ned=4, Nc=2, Ns=12, C=0.1, Ped=0.25, Da=0.1, Wa=0.2, Hr=0.1, Wr=10, lamda=400, L=0.03, arga='none', argj='none', arged='false',sigma=1, d_min=1, d_max=3, clust_alpha=1):
        ...
        super(z_bfoa_multiniche_sharing_v4_raw_for_debug, self).__init__()
        ...
        #RAWDEBUG self._points(self.__agents)
        ...
        for l in range(Ned):
            ...
            for k in range(Nre):
                ...
                for j in range(Nc):
                    ...
                    #RAWDEBUG self._points(self.__agents)  # Add to the animation

                    #RAWDEBUG self.__AvgSteps.append(sum(C_a)/n)
                    #RAWDEBUG self.__AvgJ.append(sum(J)/n)
                    #RAWDEBUG self.__AvgJFit.append(sum(J_fit)/n)
                ...
                #END of WHILE
                #RAWDEBUG print('Number of CLusters',k)
                ...
                #RAWDEBUG print('Seperation Done')
                #RAWDEBUG print(print(DataFrame(self.centdis_mat)))
                #RAWDEBUG print(print(DataFrame(self.cluster_centroids)))
                #REassign of Every Indivisual
                #RAWDEBUG print('Number of Centroids Remain',k)
                ...
                #Reassigned Done
                #RAWDEBUG print('Number of Clusters', k)
                #RAWDEBUG print(clusters_assigned) 
                #RAWDEBUG print(cluster_capacity)
                ...
                while p<n:
                    ...
                    p = p+1    
                ########################################################
                #RAWDEBUG print('Number of Niches Found', num_niches)
                #RAWDEBUG self.__NumNiches.append([num_niches])
                #RAWDEBUG print(niches)
                #RAWDEBUG print('Associated Niche', associated_niche)
                #RAWDEBUG print('Associated Niche Peak', associated_niche_peak)
                ...
                q=0
                #RAWDEBUG print('JAll', J_all)
                #RAWDEBUG print('Gamma',gamma)
                #RAWDEBUG print('Delta', delta)
                ...
                while True:
                    if (delta<J_sum):
                        ...
                        #RAWDEBUG print('selection', q, selected_index, associated_niche[selected_index],associated_niche_peak[selected_index] )
                        J_select[q] = True
                        count = count +1
                        #delta = delta + J_sum
                        delta = delta + P
        ...
        print('Total Evalutions',self.evaluations)
        #f.close() 
