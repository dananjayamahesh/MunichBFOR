...
class z_bfoa_multiniche_clustering_v4(intelligence.sw):
    """
     Dynamic Niche clustering with less calculations
     Initial Adaptive K-Means Clustering algorithms - WORKING
    ...
    def __init__(self, n, function, lb, ub, dimension, iteration, Nre=16, Ned=4, Nc=2, Ns=12, C=0.1, Ped=0.25, Da=0.1, Wa=0.2, Hr=0.1, Wr=10, lamda=400, L=0.03, arga='none', argj='none', arged='false',sigma=1, d_min=1, d_max=3, clust_alpha=1):
        ...
        super(z_bfoa_multiniche_clustering_v4, self).__init__()
        ...
        self.sigma_cluster = 2 #0.2 #1.5#0.5 #0.2 #SO far 1.5 is good for sparsly distributed centroids/peaks 
        #this is just a niche count to take, not used in the algorithm else where
