...
class abfo2(intelligence.sw):
    """
    Bacteria Foraging Optimization
    """

    def __init__(self, n, function, lb, ub, dimension, iteration, Nre=16, Nel=4, Nc=2, Ns=12, C=0.1, Ped=0.25, lamda=400):
        """
            ...
            for k in range(Nre):
                ...
                for j in range(Nc):
                    ...
                    for i in range(n):
                        ...
                        C_a[i] = 1 / \
                            (1 + (lamda / np.abs(J[i] - function(Gbest))))
