...
class z_bfoa_swarm1_dev1(intelligence.sw):
    """
    ...
    def __init__(self, n, function, lb, ub, dimension, iteration, Nre=16, Ned=4, Nc=2, Ns=12, C=0.1, Ped=0.25, Da=0.1, Wa=0.2, Hr=0.1, Wr=10, lamda=400):
        ...
        super(z_bfoa_swarm1_dev1, self).__init__()
                    ...
                    for i in range(n):
                       ...
                       # Monitoring
                        if(i == n / 2):
                            ...
                            print(C_a[i], J_fit[i], J_cc[i], J[i],
                                  (J_fit[i] + J_cc[i]), J_best)
                        # Start Swim Steps
                        for m in range(Ns):
